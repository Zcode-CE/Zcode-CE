...
- **The narrow-screen (phone) layout is still being fixed**: at narrow widths (roughly 390px and below) the sidebar can clip the main content area and the send button can fall outside the visible area — this repository is fixing that narrow-screen layer; **desktop widths are unaffected**.
