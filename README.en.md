...
| Headless server + Web panel | Works without a desktop environment: `zcode --web` serves the panel; open it from any browser (phones included) | `pnpm dev:web` (dev); `pnpm build:zcode` (standalone package) |
