...
| **开源文档能力** | Office 文档能力（Word / PowerPoint / Excel）由 MIT 许可的开源实现提供，不依赖官方闭源插件。**当前部分能力依赖系统已安装的 Python 3**，后续版本将改为自带运行时           |
...
| 能力         | 状态                                                                                                                                                                              |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **PDF 制作** | 计划补齐。官方实现含 LaTeX / HTML 双链路，且其 Office 插件授权禁止商业使用；本版将复用 [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 的成熟方案 |
